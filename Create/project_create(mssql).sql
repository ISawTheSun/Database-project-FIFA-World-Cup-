...
CREATE TABLE Druzyna (
    ...
    nazwaPanstwa varchar(30)  NOT NULL,
...
CREATE TABLE Sedzia (
    ...
    imieSedzi varchar(30)  NOT NULL,
    nazwiskoSedzi varchar(30)  NOT NULL,
...
CREATE TABLE Stadion (
    ...
    NazwaStadionu varchar(30)  NOT NULL,
...
CREATE TABLE Trener (
    ...
    imieTrenera varchar(30)  NOT NULL,
    nazwiskoTrenera varchar(30)  NOT NULL,
